...
(check-expect (same-struct? (parse-expression "4 * 2 ") (parse-expression "4 *2")) #t)
(check-expect (same-struct? (parse-expression "4 * 2 ") (parse-expression "4")) #f)
...
(check-expect (get-src (parse-expression "4 * 2 ")) '#s(src 1 1 0 6 1 5 #f))
(check-expect (get-src (parse-statement "main();")) '#s(src 1 1 0 8 1 7 #f))
(check-expect (get-src (car (parse-program "int i = 5;"))) '#s(src 1 1 0 11 1 10 #f))
